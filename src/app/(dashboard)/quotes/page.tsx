              ...
              {isLoadingProposals ? (
                ...
                filteredProposals.map((proposal) => (
                  <TableRow 
                    ...
                    onClick={() => router.push(`/dashboard/quotes/${proposal.id}`)}
                  >
                    ...
                    <TableCell>
                        <DropdownMenu>
                           ...
                           <DropdownMenuContent align="end" onClick={(e) => e.stopPropagation()}>
                             ...
                             <DropdownMenuItem onClick={() => router.push(`/dashboard/quotes/${proposal.id}`)}>
                               Görüntüle / Düzenle
                             </DropdownMenuItem>
                             <DropdownMenuItem onClick={() => router.push(`/dashboard/quotes/${proposal.id}/print?customerId=${proposal.customerId}`)}>
                               Yazdır / İndir
                             </DropdownMenuItem>
